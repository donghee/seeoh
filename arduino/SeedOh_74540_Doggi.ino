...
#define APIKEY         "Hq_cC9Ff8HGu5he9tkK0H8OCNxSSAKxLV3dYSkcyVU9hND0g" // your cosm api key
#define FEEDID         74540 // your feed ID
#define USERAGENT      "Cosm Arduino Example (74540)" // user agent is the project name
...
void draw_temp_humidity() {
  ...
  graphic.Print("58",20,-10,3); //TODO: Change Real Sensor
